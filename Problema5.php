...
// 1. Recepción y Sanitización (Trimming) para eliminar espacios accidentales [cite: 101]
if (isset($_POST['nombre']) && isset($_POST['edad'])) {

    $Nombre = trim($_POST['nombre']);
    $Edad = trim($_POST['edad']);

    // 2. Salida del nombre [cite: 122]
    // Usamos htmlspecialchars por seguridad al mostrar datos del usuario
    echo "El nombre es: " . htmlspecialchars($Nombre) . "<br>";

    // 3. Lógica de validación de edad [cite: 124, 126]
